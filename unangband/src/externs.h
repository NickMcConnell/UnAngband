...
extern s32b *slays;
extern int slay_index_to_ability[32];
extern u32b ability_to_slay_index[ABILITY_MAX];
extern int ability_to_magic_slay_power[ABILITY_MAX];
...
extern sint object_damage_multiplier(object_type *o_ptr, const monster_type *m_ptr, bool floor, bool use_player);
...
extern void player_flags(u32b f0[ABILITY_ARRAY_SIZE],u32b *f1, u32b *f2, u32b *f3, u32b *f4);
...
extern bool list_object_flags(const s16b ability[ABILITY_MAX], const u32b f0[ABILITY_ARRAY_SIZE], u32b f1, u32b f2, u32b f3, u32b f4, int pval, int mode);
...
extern void object_flags(const object_type *o_ptr, u32b f0[ABILITY_ARRAY_SIZE], u32b *f1, u32b *f2, u32b *f3, u32b *f4);
...
extern bool object_ability_add(object_type *o_ptr, int ability, int value);
extern bool object_ability_set(object_type *o_ptr, int ability, int value);
extern bool object_ability_div(object_type *o_ptr, int ability, int value);
extern bool object_ability_clear(object_type *o_ptr, int ability);
extern bool object_learn_ability(object_type *o_ptr, int ability, bool floor);
extern void object_flags_known(const object_type *o_ptr, u32b f0[ABILITY_ARRAY_SIZE], u32b *f1, u32b *f2, u32b *f3, u32b *f4);
extern void object_obvious_flags(object_type *o_ptr, bool floor);
extern void object_can_ability(object_type *o_ptr, int ability, bool floor);
extern void object_may_ability(object_type *o_ptr, int ability, bool floor);
extern void object_not_ability(object_type *o_ptr, int ability, bool floor);
extern void object_can_flags(object_type *o_ptr, u32b f0[ABILITY_ARRAY_SIZE], u32b f1, u32b f2, u32b f3, u32b f4, bool floor);
extern void object_not_flags(object_type *o_ptr, u32b f0[ABILITY_ARRAY_SIZE], u32b f1, u32b f2, u32b f3, u32b f4, bool floor);
extern void object_may_flags(object_type *o_ptr, u32b f0[ABILITY_ARRAY_SIZE], u32b f1, u32b f2, u32b f3, u32b f4, bool floor);
...
extern void update_slot_flags(int slot, u32b f0[ABILITY_ARRAY_SIZE], u32b f1, u32b f2, u32b f3, u32b f4);
extern void equip_can_flags(u32b f0[ABILITY_ARRAY_SIZE], u32b f1,u32b f2,u32b f3, u32b f4);
extern void equip_not_flags(u32b f0[ABILITY_ARRAY_SIZE], u32b f1,u32b f2,u32b f3, u32b f4);
extern void inven_drop_flags(object_type *o_ptr);
extern int bow_multiplier(int sval);
extern s32b slay_power(u32b s_index);
extern u32b slay_index(const s16b *ability, int ability_count);
extern s16b object_to_h(const object_type *o_ptr, int attack);
extern s16b object_to_d(const object_type *o_ptr, int attack);
extern s16b object_to_a(const object_type *o_ptr, int attack);
...
extern bool region_illusion_hook(int y, int x, s16b d, s16b region);
...
/* spells1.c */
extern u32b player_smart_flags(u32b f0[ABILITY_ARRAY_SIZE], u32b f1,u32b f2,u32b f3, u32b f4);
extern u32b monster_smart_flags(int m_idx);
extern bool player_can_flags(int who, u32b f0[ABILITY_ARRAY_SIZE], u32b f1,u32b f2,u32b f3, u32b f4);
extern bool player_not_flags(int who, u32b f0[ABILITY_ARRAY_SIZE], u32b f1,u32b f2,u32b f3, u32b f4);
